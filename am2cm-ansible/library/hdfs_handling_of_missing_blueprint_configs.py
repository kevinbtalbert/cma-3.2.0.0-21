...
def run_module():
    ...
    result['changed'], result['message'] = hdfs_post_transition.do_handling_of_missing_blueprint_configs()

    if result['changed']:
        module.exit_json(**result)
    else:
        module.fail_json(msg='Exception doing hdfs handling of missing blueprint configs chapter', **result)
